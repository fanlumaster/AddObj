...
HRESULT __stdcall CAddFactory::QueryInterface(const IID &iid, void **ppv)
{
...
HRESULT __stdcall CAddFactory::CreateInstance(IUnknown *pUnknownOuter, const IID &iid, void **ppv)
{
    //
